...
Motor RMotor(R_MOTOR_SPEED_PIN, R_MOTOR_CONTROL1_PIN, R_MOTOR_CONTROL2_PIN, 70, 255, 32);
...
int centerState(){
  checkBumpers();
//  const int distParede = 10;
//  if(getDistance(LSonar) < distParede)
//  {
//    rotateAngle(-10);
//    moveForward (65,80);
//    delay(250);
//  }
//  else if(getDistance(RSonar) < distParede)
//  {
//    rotateAngle(10);
//    moveForward (65,80);
//    delay(250);
...
int putOutState(){
  ...
  if ( getDistance(RSonar) >= 100 && getDistance(LSonar) < 100)
  {
    rotateAngle(180); 
  }
